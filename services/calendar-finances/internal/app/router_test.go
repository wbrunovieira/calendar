...
// (/api/v1/health/invariants and the invoice-cycle plan) and the audited
// balance adjustment. Adding a route here
...
var wantRoutes = []string{
	...
	"GET /api/v1/bank-accounts/{id}/credit-usage",
	...
	"POST /api/v1/bank-accounts/{id}/statement/reconcile",
	"GET /api/v1/invoices",
	...
	"GET /api/v1/recurring-transactions/pending",
	"GET /api/v1/transactions",
	"GET /api/v1/transactions/daily-balances",
	"GET /api/v1/transactions/cashflow-summary",
